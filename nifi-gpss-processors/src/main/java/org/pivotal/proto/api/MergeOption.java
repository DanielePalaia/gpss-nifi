...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return api.GpssOuterClass.internal_static_api_MergeOption_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return api.GpssOuterClass.internal_static_api_MergeOption_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            api.MergeOption.class, api.MergeOption.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof api.MergeOption)) {
      return super.equals(obj);
    }
    api.MergeOption other = (api.MergeOption) obj;
  ...
  public static api.MergeOption parseFrom(
  ...
  public static api.MergeOption parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static api.MergeOption parseFrom(
  ...
  public static api.MergeOption parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static api.MergeOption parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static api.MergeOption parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(api.MergeOption prototype) {
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public api.MergeOption getDefaultInstanceForType() {
      return api.MergeOption.getDefaultInstance();
    }

    @java.lang.Override
    public api.MergeOption build() {
      api.MergeOption result = buildPartial();
    ...
    @java.lang.Override
    public api.MergeOption buildPartial() {
      api.MergeOption result = new api.MergeOption(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof api.MergeOption) {
        return mergeFrom((api.MergeOption)other);
      } else {
    ...
    public Builder mergeFrom(api.MergeOption other) {
      if (other == api.MergeOption.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      api.MergeOption parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (api.MergeOption) e.getUnfinishedMessage();
  ...
  private static final api.MergeOption DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new api.MergeOption();
  }

  public static api.MergeOption getDefaultInstance() {
